...
img1 = cv2.imread('output_piecewise.jpg', 0)

# keskinlestirme
kernel = np.array([[-1, -1, -1], [-1, 9, -1], [-1, -1, -1]])
sharping = cv2.filter2D(img1, -1, kernel)
# goruntuyu projeye kaydetmek icin gerekli fonksiyon
cv2.imwrite('./sharpen-img/soru2-sonuc(Keskinlestirme).jpg', sharping)

# bulanıklastırma
blurred_1 = cv2.blur(img1, (5, 5))
# goruntuyu projeye kaydetmek icin gerekli fonksiyon
cv2.imwrite('./sharpen-img/soru2-sonuc(Bulaniklastirma).jpg', blurred_1)
